...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="../../../css/style_tampilbuku.css" />
...
<header>
    ...
    <div class="tampilan_buku">
    <div id="head"><span>Daftar Buku</span></div>
    <table border="0" cellspacing="3" width="100%">
        
        <?php foreach ($buku as $rows) : ?>
        <tr>
            <td rowspan="7" style="width: 200px;"><a href="pinjam.php?isbn=<?= $rows['isbn']; ?>"><img src="../../../img/<?= $rows['cover']; ?>" style="border-radius: 10px; width: 220px; height: 220px;"></a></td>
            </tr>
